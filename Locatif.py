...
# Traie les lignes de 2024 - 2022 - 2023 - adresses

# IMPORTANT CHANGER LE NOM DU FICHIER GMBI
# Il faut que le fichier soit dans le dossier Locatif tout comme le fichier G2GAI
# Si vous changez le dossier Locatif de place, il faut penser à changer le chemin (voir variable chemin)
...
chemin = 'C:/Users/internet/Documents/Locatif'  # Chemin où se trouve les fichiers GMBI et G2GAI
...
nom_fichier_GMBI = 'GMBI - Domont.csv'  # Nom du fichier GMBI
nom_fichier_G2GAI = 'DGFIP_2022_2023_2024.csv'  # Nom du fichier G2GAI
# Nom des fichiers en sortie
nom_nouveau_fichier = nom_fichier_GMBI  # Fichier qui sera complet dans le dossier "rendu" ! pas besoin de créer le fichier
nom_G2GAI_non_trouve = 'G2GAI Reste.csv'  # Nom du fichier où les lignes de G2GAI n'ont pas été traité à la fin ! pas besoin de créer le fichier
nom_GMBI_non_trouve = 'GMBI Reste.csv'  # Nom du fichier où les lignes de GMBI n'ont pas été traité à la fin ! pas besoin de créer le fichier
...
def charger_ecrire_fichier(input_file, output_file, non_trouve_file):
    ...
    with open(input_file, 'r', newline='', encoding='utf-8-sig') as fichier_entree:
        ...
        with open(output_file, 'w', newline='', encoding='utf-8-sig') as fichier_sortie:
        ...
        with open(non_trouve_file, 'w', newline='', encoding='utf-8-sig') as non_trouve:
...
def initialiser_variables_adresse(ligne_G2GAI):
    ...
    # Récupère que les caractères de l'adresse
    adresse_G2GAI_caracteres = re.sub(r'\d', '', adresse_G2GAI)
    # Récupère que les nmbres de l'adresse
        ...
        for ligne_G2GAI in donnees_fichierG2GAI:
            ...
            if ligne_G2GAI[27].strip() != '':
                ...
                if (departement_local_GMBI == departement_logement_G2GAI and
                    ...
                    print("2024 correspondance trouvé")
...
for ligne_G2GAI in donnees_fichierG2GAI:
    ...
    if ligne_G2GAI[16] == "L" and ligne_G2GAI[12] not in valeurs_g2gai_traitees:
...
for ligne_G2GAI in donnees_fichierG2GAI:
    ...
    # Si le logement est Domaniale
    if ligne_G2GAI[16] == "L" and ligne_G2GAI[12] in valeurs_g2gai_traitees2022:
...
for ligne_G2GAI in donnees_fichierG2GAI:
    ...
    # Si le logement est Domaniale
    if ligne_G2GAI[16] == "L" and ligne_G2GAI[12] in valeurs_g2gai_traitees2023:
...
while similarite_minimum >= 80:
    print(f"Adresse à {similarite_minimum}% toutes conditions")
    # Parcourir les lignes du fichier G2GAI
    for ligne_G2GAI in donnees_fichierG2GAI:
...
similarite_minimum = 100
while similarite_minimum >= 80:
    print(f"Adresse à {similarite_minimum}% sans num rue")
    # Parcourir les lignes du fichier G2GAI
    for ligne_G2GAI in donnees_fichierG2GAI:
...
similarite_minimum = 100
while similarite_minimum >= 80:
    print(f"Adresse à {similarite_minimum}% sasns num rue, nbr pièces")
    # Parcourir les lignes du fichier G2GAI
    for ligne_G2GAI in donnees_fichierG2GAI:
...
similarite_minimum = 100
while similarite_minimum >= 80:
    print(f"Adresse à {similarite_minimum}% sasns num rue, nbr pièces, surface")
    # Parcourir les lignes du fichier G2GAI
    for ligne_G2GAI in donnees_fichierG2GAI:
