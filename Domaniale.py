...
# Traie les lignes de 2024 - 2022 - 2023 - en cours d'abandon - adresses

# Créer trois nouveaux fichiers :
...
chemin = 'C:/Users/internet/Documents/Domaniale'  # Chemin où se trouve les fichiers GMBI et G2GAI
...
nom_nouveau_fichier = "TEST " + nom_fichier_GMBI  # Fichier qui sera complet dans le dossier "rendu" ! pas besoin de créer le fichier
nom_G2GAI_non_trouve = 'TEST G2GAI Reste.csv'  # Nom du fichier où les lignes de G2GAI n'ont pas été traité à la fin ! pas besoin de créer le fichier
nom_GMBI_non_trouve = 'TEST GMBI Reste.csv'  # Nom du fichier où les lignes de GMBI n'ont pas été traité à la fin ! pas besoin de créer le fichier
nom_abandon_non_trouve = 'TEST Abandon Reste.csv'

# # TESTE SUR TOUS LES LOGEMENTS
# # Noms des fichiers en entée
# nom_fichier_GMBI = '1_157000019_999_240410_141903_V2024.csv'  # Nom du fichier GMBI
                        ...
                        for ligne_similaire_GMBI in donnees_fichierGMBI:
                            if (ligne_similaire_GMBI[9] == ligne_GMBI[9] and
                                ...
                                if verifier_date_arrivee(ligne_similaire_GMBI, date_arrivee) and verifier_vacance_occupation(ligne_similaire_GMBI):
                                    ...
                                    nouvelle_ligne = creer_nouvelle_ligne(ligne_similaire_GMBI)
